...
> **Parent plans**: §3.3, §3.5, §4, §9.2 of `plans/CHUNK_8_REPLICA_ITEM_TRIGGER_PLAN.md`. `plans/replica-ir-atomic-rewrite.md` §9.1 AND `plans/nonsummon-typed-schema.md` §9 are the upstream gates — 8A.5 lands BEFORE 8B.
>
...
Against sibling `plans/nonsummon-typed-schema.md`:
